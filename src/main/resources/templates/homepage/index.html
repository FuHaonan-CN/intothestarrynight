...
<head>
    ...
    <link href="../static/css/styles.css?v=1.6" rel="stylesheet">
    <link href="../static/css/queries.css?v=1.6" rel="stylesheet">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" style="text-align: center">
                        <li><a href="/User_updateInput_user?id="><span
                        ...
                        <li><a href="/Post_selectAll_post?rightname="><span
...
<section class="hero" id="hero">
    ...
    <!--倒计时-->
    <div class="col-md-8 col-md-offset-2 text-center">
        距离<input type="text" id="date2" value="">
    </div>
    <div class="col-md-8 col-md-offset-2 text-center">
            ...
            <div class="col-md-12 text-center">
                <div id="firstSlider">
                    <ul class="slides">
                        <li>
                            <div class="avatar">
                                <img src="../static/img/av-blaz.png" alt="Blaz Robar">
                            </div>
                        ...
                        <li>
                            <div class="avatar">
                                <img src="../static/img/av-pete.png" alt="Pete Finlan">
                            </div>
                        ...
                        <li>
                            <div class="avatar">
                                <img src="../static/img/av-doge.png" alt="Doge Finbar">
                            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 features-leftcol wp2">
                <iterator value="sixNews" begin="0" end="1" var="news">
                    <a href="/News_queryById_news?id=" target="_blank">
                        <img src="../upload/" width="250" height="100" border="0" alt="［阅读］"></a>
                    <h1 align="center"><a href="/News_queryById_news?id="></a></h1>
                    <p class="margin-bottom">一句话概括新闻
                        <a href="/News_queryById_news?id=">［阅读］</a>
                    </p>
                </iterator>
            </div>
            <div class="col-md-6 features-rightcol wp3">
                <iterator value="#request.sixNews" begin="2" end="3" var="news">
                    <a href="/News_queryById_news?id=" target="_blank">
                        <img src="../upload/" width="250" height="100" border="0" alt="［阅读］"></a>
                    <h1 align="center"><a href="/News_queryById_news?id="></a></h1>
                    <p class="margin-bottom">一句话概括新闻
                            ...
                            <div class="col-md-4">
                                <div class="flat-box">
                                    <div class="colourway colour1">
                                        <img src="../static/starry/1.jpg" width="350px" height="350px" alt="">
                                    </div>
                                    <p class="title">星座图</p>
                            ...
                            <div class="col-md-4">
                                <div class="flat-box">
                                    <div class="colourway colour2">
                                        <img src="../static/starry/2.jpg" width="350px" height="350px" alt="">
                                    </div>
                                    <p class="title">黑洞</p>
                                    <p class="feature-text">查看详情</p>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="flat-box">
                                    <div class="colourway colour3">
                                        <img src="../static/starry/3.jpg" width="350px" height="350px" alt="">
                                    </div>
                                    <p class="title">太阳系</p>
                                    <p class="feature-text">查看详情</p>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="flat-box">
                                    <div class="colourway colour4">
                                        <img src="../static/starry/4.jpg" width="350px" height="350px" alt="">
                                    </div>
                                    <p class="title">银河系</p>
                                    <p class="feature-text">查看详情</p>
                                </div>
...
<script src="../static/js/scripts.js?v=1.7"></script>
